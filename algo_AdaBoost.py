...
# -*- coding: utf-8 -*-
# @Author: lancezhange
# @Date:   2015-08-21 15:00:04
# @Last Modified by:   lancezhange
# @Last Modified time: 2015-08-21 15:03:12
...
def getModel(x_train, x_test, y_train, y_test, print_metrics=True):
    '''
    Trains a classifier. Here we use AdaBoost.
    ...
    Returns:
      A classifier (sklearn.ensemble.AdaBoostClassifier).
    '''
